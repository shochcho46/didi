        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <a class="btn-floating btn-sm btn-dark"  href="{{ route('mainmenus.disable',$value->id) }}" onclick="event.preventDefault(); document.getElementById('disa{{$value->id}}').submit();">
                    ...
                    <form method="POST" id="disa{{$value->id}}" action="{{ route('mainmenus.disable', $value->id) }}" style="display: none;">
                        @csrf
                        @method('PUT')
