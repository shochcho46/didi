        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <a class="btn-floating btn-sm btn-success"  href="{{ route('submenus.active',$value->id) }}" onclick="event.preventDefault(); document.getElementById('act{{$value->id}}').submit();">
                    ...
                    <form method="POST" id="act{{$value->id}}" action="{{ route('submenus.active', $value->id) }}" style="display: none;">
                        @csrf
                        @method('patch')
