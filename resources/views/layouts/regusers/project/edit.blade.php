        ...
        <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 col-xl-8">
            ...
            <div class="card">
                ...
                <div class="card-body px-lg-5">
                    ...
                    <!-- Form -->
                    <form method="POST" class="" action="{{ route('projects.update', $data->id) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="md-form mt-3">
                            <select name="submenu_id" id="submenu_id" class="mdb-select colorful-select dropdown-secondary" searchable="Search here.." required>
                                <option value="{{ $data->submenu_id }}" disabled selected>{{ $data->submenu->sub_name }}</option>
                        ...
                        <div class="error text-danger m-2">{{ $errors->first('submenu_id') }}</div>
                        @endif

                        <!-- Name -->
                        <div class="md-form mt-3">
                            <input type="text" id="heading" name="heading" placeholder="Project Heading" value="{{ old('heading')??$data->heading }}" required class="form-control">
                        ...
                        <div class="md-form ">
                            ...
                            <textarea id="description" class="md-textarea form-control" name="description" placeholder="Project Description" rows="3" required maxlength="1500">{{ old('description')??$data->description }}</textarea>
                        ...
                        <div class="md-form input-group mb-3">
                            ...
                            <input type="text" class="form-control" name="amount" value="{{ old('amount')?? $data->amount }}" id="amount" placeholder="Total Money" required>
                        ...
                        <div class="md-form">
                            ...
                            <input placeholder="Selected date" type="text" id="date-picker-example" value="{{ old('startdate')?? $data->startdate}}" name="startdate" class="form-control  datepicker" required>
                        ...
                        <div class="error text-danger m-2">{{ $errors->first('startdate') }}</div>
                        @endif
                        ...
                        <div class="typeahead">
                            ...
                            <input type="text" data-role="tagsinput"   value="{{ old('skill_name')?? $data->skill_name}}" name="skill_name" id="skill_name" autocomplete="off" class="form-control " placeholder="Type & press enter.Click X to remove." required>
                        ...
                        <input type="hidden" id="user_id" name="user_id"  value="{{ $data->user_id }}" required class="form-control">
                        <!-- Sign in button -->
