        ...
        <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 col-xl-8">
            ...
            <div class="card">
                ...
                <div class="card-body px-lg-5">
                    ...
                    <!-- Form -->
                    <form method="POST" class="" action="{{ route('projects.store') }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <!-- Name -->
                        <div class="md-form mt-3">
                            <input type="text" id="heading" name="heading" placeholder="Project Heading" value="{{ old('heading') }}" required class="form-control">
                        ...
                        <div class="md-form input-group mb-3">
                            ...
                            <input type="number" class="form-control" name="amount" value="{{ old('amount') }}" id="amount" placeholder="Total Money" min="1" required>
                        ...
                        <div class="md-form">
                            ...
                            <input placeholder="Selected date" type="text" id="date-picker-example" value="{{ old('startdate') }}" name="startdate" class="form-control  datepicker" required>
                        ...
                        <input type="hidden" id="user_id" name="user_id"  value="{{ Auth::user()->id }}" required class="form-control">
                        <!-- Sign in button -->
