            ...
            <!-- Material form subscription -->
                        ...
                        <div class="card">
                            ...
                            <div class="card-body px-lg-5">
                                ...
                                <!-- Form -->
                                <form method="POST" action="{{ route('gigs.update',$data->id) }}" enctype="multipart/form-data">
                                    ...
                                    <div class="md-form mt-3">
                                        <input type="text" id="heading" name="heading"  placeholder="Gig Heading" value="{{ old('heading') ?? $data->heading }}"required class="form-control">
                                    ...
                                    <div class="md-form ">
                                        ...
                                        <textarea id="description" class="md-textarea form-control" name="description" placeholder="Gig Description" rows="3"  required maxlength="300">{{ old('description') ?? $data->description }}</textarea>
                                    ...
                                    <div class="md-form mb-3">
                                        <div class="input-group mb-3">
                                            ...
                                            <div class="custom-file ">
                                                ...
                                                <input type="file" class="custom-file-input"  id="piclocation" name ="piclocation" accept='image/*'   onchange="loadFile(event)" >
                                    ...
                                    <div class="md-form text-center mt-3">
                                        ...
                                        <img id="output" class=" uploadImageBoxSize" src="{{ $data->piclocation }}"  >
                                            <p>
                                    ...
                                    <div class="md-form input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" name="amount" id="amount" placeholder="Total Money" value="{{ old('amount') ?? $data->amount }}" required >
