<nav class="navbar fixed-bottom navbar-expand-lg navbar-dark scrolling-navbar double-nav secondary-color-dark d-md-none">
  ...
  <ul class="nav mr-auto">
      <li class="ml-3">
          ...
          <a class="waves-effect mt-1" href="{{ route('reguser.index') }}"><i class="mdi mdi-light mdi-home mdi-18px"></i></a>
      </li>
  ...
  <ul class="nav mr-center">
      <li class="">
          <a href="{{ route('reguser.gigindex') }}" class="waves-effect mt-1 navNewItem"><i class="mdi mdi-light mdi-rotate-orbit mdi-spin"></i></a>
      </li>
