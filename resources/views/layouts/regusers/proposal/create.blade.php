        ...
        <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 col-xl-8">
            ...
            <div class="card">
                ...
                <div class="card-body px-lg-5">
                    ...
                    <!-- Form -->
                    <form method="POST" class="" action="{{ route('proposals.store') }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="md-form input-group mb-3">
                            ...
                            <label for="serial"> {{ $project->jobtype }} Money </label>
                        ...
                        <input type="hidden" id="project_id" name="project_id"  value="{{ $project->id }}" required class="form-control">
                        <!-- Sign in button -->
