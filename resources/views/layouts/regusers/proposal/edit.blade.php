        ...
        <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 col-xl-8">
            ...
            <div class="card">
                ...
                <div class="card-body px-lg-5">
                    ...
                    <!-- Form -->
                    <form method="POST" class="" action="{{ route('proposals.update', $data->id) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="md-form ">
                            ...
                            <textarea id="description" class="md-textarea form-control" name="description" placeholder="Proposal Description" rows="3" required maxlength="1000">{{ old('description')??$data->description }}</textarea>
                        ...
                        <div class="md-form input-group mb-3">
                            ...
                            <input type="number" class="form-control" name="amount" value="{{ old('amount') ?? $data->amount }}" id="amount" placeholder="Total Money" min="1" required>
                            <label for="serial"> {{ $data->project->jobtype }} Money </label>
                        ...
                        <input type="hidden" id="project_id" name="project_id"  value="{{ $data->project_id }}" required class="form-control">
