    ...
    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
        ...
        <div class="card m-2">
            ...
            <div class="md-form text-center p-2">
                ...
                <img id="output" class="img-fluid rounded-circle uploadImageBoxSize p-2" src="{{$user->piclocation}}"
                    alt="No Image">
                <p class="mt-2">
        ...
        {{-- <div class="form-group text-center m-5">
                            ...
                            <img id="output" class=" img-thumbnail p-2 " width="auto" height="auto" src="{{$user->piclocation}}"
        alt="No Image" >
