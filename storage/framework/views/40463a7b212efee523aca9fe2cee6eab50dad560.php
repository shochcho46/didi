    ...
    <?php endif; ?>
     ...
     <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                ...
                <?php echo $__env->make('layouts.admins.gig.gigdes', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

            </div>

            <div class="col-xs-0 col-sm-0 col-md-3 col-lg-3 col-xl-3">
                <?php echo $__env->make('layouts.admins.gig.gigaction', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->make('layouts.admins.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Setup\xampp\htdocs\Didi\resources\views/layouts/admins/gig/show.blade.php ENDPATH**/ ?>