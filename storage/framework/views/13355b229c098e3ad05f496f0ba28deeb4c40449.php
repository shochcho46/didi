        ...
        <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 col-xl-8">
            ...
            <div class="card">
                ...
                <div class="card-body px-lg-5">
                    ...
                    <!-- Form -->
                    <form method="POST" class="" action="<?php echo e(route('projects.store')); ?>" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="md-form mt-3">
                            <select name="mainmenu_id" id="mainmenu_id" class="mdb-select colorful-select dropdown-secondary" searchable="Search here.." required>
                                ...
                                <?php $__currentLoopData = $mainmenu; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($value->id); ?>"><?php echo e($value->main_name); ?></option>
                        ...
                        <div class="md-form mt-3">
                            <select name="submenu_id" id="submenu_id" class="mdb-select colorful-select dropdown-secondary" searchable="Search here.." required>
                                <option value="" disabled selected>Sub menu</option>
                        ...
                        <!-- Name -->
                        <div class="md-form mt-3">
                            <input type="text" id="heading" name="heading" placeholder="Project Heading" value="<?php echo e(old('heading')); ?>" required class="form-control">
                        ...
                        <div class="md-form ">
                            ...
                            <textarea id="description" class="md-textarea form-control" name="description" placeholder="Project Description" rows="3" required maxlength="1500"></textarea>
                        ...
                        <div class="md-form">
                            ...
                            <input placeholder="Selected date" type="text" id="date-picker-example" value="<?php echo e(old('startdate')); ?>" name="startdate" class="form-control  datepicker" required>
...
<?php echo $__env->make('layouts.regusers.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Setup\xampp\htdocs\Didi\resources\views/layouts/regusers/project/create.blade.php ENDPATH**/ ?>