            ...
            <!-- Material form subscription -->
                        <div class="card">
                            ...
                            <div class="card-body px-lg-5">
                                ...
                                <!-- Form -->
                                <form method="POST" class="md-form" action="<?php echo e(route('gigs.store')); ?>" enctype="multipart/form-data">


                                    <?php echo csrf_field(); ?>
                                    <!-- Name -->
                                    <div class="md-form mt-3">
                                        <input type="text" id="heading" name="heading"  placeholder="Gig Heading" value="<?php echo e(old('heading')); ?>"required class="form-control">
...
<?php echo $__env->make('layouts.regusers.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Setup\xampp\htdocs\Didi\resources\views/layouts/regusers/gig/create.blade.php ENDPATH**/ ?>