            ...
            <div class="card card-cascade wider mb-4">
              ...
              <div class="card-body card-body-cascade text-center">
                ...
                <p class="card-text text-justify">
                    ...
                    <a href ="<?php echo e(route('admins.proposalshow', $value->id)); ?>" class="purple-text">Read more </i></a>
...
<?php echo $__env->make('layouts.admins.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Setup\xampp\htdocs\Didi\resources\views/layouts/admins/proposal/list.blade.php ENDPATH**/ ?>