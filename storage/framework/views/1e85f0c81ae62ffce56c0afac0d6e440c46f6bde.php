    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
            ...
            <div class="text-center">
                ...
                <a class="btn-floating btn-sm btn-success" href="<?php echo e(route('projects.enable',$value->id)); ?>">
...
<?php echo $__env->make('layouts.regusers.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Setup\xampp\htdocs\Didi\resources\views/layouts/regusers/project/disablelist.blade.php ENDPATH**/ ?>