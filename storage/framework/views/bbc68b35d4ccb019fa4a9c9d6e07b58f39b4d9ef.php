    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
            ...
            <div class="text-center">
                ...
                <a class="btn-floating btn-sm btn-primary" href="<?php echo e(route('projects.edit',$value->id)); ?>">
                ...
                <a class="btn-floating btn-sm btn-dark" href="<?php echo e(route('projects.proposaldisable',$value->id)); ?>">
                    <i class="mdi mdi-message-bulleted-off mdi-18px"></i>
                </a>
                <?php endif; ?>

                <?php if($value->proposal == "no"): ?>
                <a class="btn-floating btn-sm btn-success" href="<?php echo e(route('projects.proposalenable',$value->id)); ?>">
                    <i class="mdi mdi-message-bulleted mdi-18px"></i>
                </a>
                <?php endif; ?>


                <a class="btn-floating btn-sm btn-blue-grey" href="<?php echo e(route('projects.pin',$value->id)); ?>">
                ...
                <form method="POST" id="del<?php echo e($value->id); ?>" action="<?php echo e(route('projects.destroy', $value->id)); ?>" style="display: none;">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.regusers.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Setup\xampp\htdocs\Didi\resources\views/layouts/regusers/project/list.blade.php ENDPATH**/ ?>