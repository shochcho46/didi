    ...
    <div class="card-body">
      ...
      <h5 class="card-title"> <?php echo e($jobInstance->user->name); ?><br>
        ...
        <div class="row">
            ...
            <?php if(($jobInstance->user_id === $jobInstance->user->id)||($jobInstance->status === "yes")): ?>
...
<!--Modal: modalPush-->
<?php /**PATH E:\Setup\xampp\htdocs\Didi\resources\views/layouts/regusers/profile/miniprofile.blade.php ENDPATH**/ ?>