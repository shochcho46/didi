        ...
        <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 col-xl-8">
            ...
            <div class="card">
                ...
                <div class="card-body px-lg-5">
                    ...
                    <!-- Form -->
                    <form method="POST" class="" action="<?php echo e(route('proposals.update', $data->id)); ?>" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="md-form ">
                            ...
                            <textarea id="description" class="md-textarea form-control" name="description" placeholder="Proposal Description" rows="3" required maxlength="1000"><?php echo e(old('description')??$data->description); ?></textarea>
                        ...
                        <div class="md-form input-group mb-3">
                            ...
                            <input type="number" class="form-control" name="amount" value="<?php echo e(old('amount') ?? $data->amount); ?>" id="amount" placeholder="Total Money" min="1" required>
                            <label for="serial"> <?php echo e($data->project->jobtype); ?> Money </label>
                        ...
                        <input type="hidden" id="project_id" name="project_id"  value="<?php echo e($data->project_id); ?>" required class="form-control">
...
<?php echo $__env->make('layouts.regusers.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Setup\xampp\htdocs\Didi\resources\views/layouts/regusers/proposal/edit.blade.php ENDPATH**/ ?>