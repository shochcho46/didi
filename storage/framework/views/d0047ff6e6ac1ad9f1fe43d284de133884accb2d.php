...
<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12  ">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            <form method="POST" id="secuirity" action="<?php echo e(route('projects.pinhome',$project->id)); ?>"
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body px-lg-5 pt-0">
                        ...
                        <div class="md-form">
                            ...
                            <?php if($errors->has('pindatehome')): ?>
                                <div class="error text-danger m-2"><?php echo e($errors->first('pindatehome')); ?></div>
                            <?php endif; ?>
...
<?php /**PATH E:\Setup\xampp\htdocs\Didi\resources\views/layouts/regusers/project/pintohome.blade.php ENDPATH**/ ?>